...
# This Browser will **NOT** be in the final verison!!
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About This Test-Browser", self)
        about_action.setStatusTip("Find out more about this Test Browser")  # Hungry!
    ...
    def navigate_mozarella(self):
        self.browser.setUrl(QUrl("https://github.com/Robotic-ui"))
...
app.setApplicationName("Test Browser")
