...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To Cyber-EDIT")
...
# Defining Open File Funtion
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","EDITOR is a simple text editor included with the OS")
...
# Creating TK Container, calling all functions
root = Tk()
TextEditor(root)
root.mainloop()